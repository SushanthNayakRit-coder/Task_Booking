...
Notifications: Console log + email simulation on approve/reject (see WORKFLOW.md)
...
user	user	USER
Only Manager can approve or reject tasks. For workflow and notification details, see WORKFLOW.md.
...
Unit tests cover TaskService (create, list, approve/reject, validation). For approval workflow and notification logic, see WORKFLOW.md.
